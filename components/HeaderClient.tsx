...
import {AboutVO} from "@/common/model"
...
export default function HeaderClient({ aboutVO }: HeaderClientProps) {
            ...
            <dialog className='modal' ref={modalRef} onClose={() => setIsModalOpen(false)} >
                <div className="modal-box bg-base-100 max-xs:p-2 overflow-x-auto">
                    <div className="min-w-60">
                        <div dangerouslySetInnerHTML={{__html: aboutVO.content}} className='min-h-48'/>
                        <div className='border-t border-base-content/30 mt-6 mb-4'/>
                        <div className='flex justify-around'>
                            {
                                [
                                    {title: 'Post', value: aboutVO.post_count},
                                    {title: 'Category', value: aboutVO.category_count},
                                    {title: 'Tag', value: aboutVO.tag_count},
                                ].map(
                                    (stat) => (
